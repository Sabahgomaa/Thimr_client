...
class GlobalNotification {
  ...
  Future<void> setUpFirebase() async {
    ...
    var ios = const DarwinInitializationSettings(defaultPresentBadge: true, defaultPresentAlert: true, defaultPresentSound: true);
  ...
  Future<void> onSelectNotification(NotificationResponse? onSelectNotification) async {
